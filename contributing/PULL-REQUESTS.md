...
[issue tracker](https://github.com/joraco-dev/prometeo/issues) or engage on the
...
Fork the project [on GitHub](https://github.com/joraco-dev/prometeo) and clone your fork
locally.

```text
$ git clone git@github.com:username/prometeo.git
$ cd prometeo
$ git remote add upstream https://github.com/joraco-dev/prometeo.git
$ git fetch upstream
```
...
Prometeo does not yet have a style guide.
...
Fixes: https://github.com/Code-and-Response/prometeo/issues/1337
...
at least two Prometeo Collaborators (one Collaborator approval is enough if the
...
`joraco-dev/prometeo` repository) is authorized to approve any other contributor's
...
[Code of Conduct]: https://github.com/joraco-dev/prometeo/doc/guides/coc.md
