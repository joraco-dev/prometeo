...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in DroneAid, creating a new issue in the `joraco-dev/prometeo`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `joraco-dev/prometeo` in a concrete and reviewable manner.

## Asking for General Help

The best place to ask for help is through the [Prometeo Slack workspace][]. Open an
...
of the [Prometeo Slack workspace][].

## Submitting a Bug Report

When opening a new issue in the `joraco-dev/prometeo` issue tracker, please provide as much
...
[Prometeo Slack workspace]: https://join.slack.com/t/code-and-response/shared_invite/enQtNzkyMDUyODg1NDU5LTdkZDhmMjJkMWI1MDk1ODc2YTc2OTEwZTI4MGI3NDI0NmZmNTg0Zjg5NTVmYzNiNTYzNzRiM2JkZjYzOWIwMWE
